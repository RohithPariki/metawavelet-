...
class DataConfig:
    ...
    def generate_training_points(self):
        ...
        x_grid1, t_grid1 = torch.meshgrid(xtest1, ttest, indexing='ij')
        x_grid2, t_grid2 = torch.meshgrid(xtest2, ttest, indexing='ij')
        
        x_test1 = x_grid1.reshape(-1)
        x_test2 = x_grid2.reshape(-1)
        t_test_eval = t_grid1.reshape(-1)
        ...
        return {
            ...
            'test': (self.n_test, x_test1, x_test2, t_test_eval, x_grid, t_grid)
        }
...
n_test, x_test1, x_test2, t_test, x_grid, t_grid = points['test']
